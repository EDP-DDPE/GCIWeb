...
--CREATE TABLE "atlas"."tipo_viabilidade"(
--    "id_tipo_viab" BIGINT IDENTITY(1,1) NOT NULL,
--    "descricao" VARCHAR(255) NOT NULL
--);
--ALTER TABLE "atlas"."tipo_viabilidade" ADD CONSTRAINT "atlas_tipo_viabilidade_id_tipo_viab_primary" PRIMARY KEY("id_tipo_viab");
--
--CREATE TABLE "atlas"."tipo_analise"(
--    "id_tipo_analise" BIGINT IDENTITY(1,1) NOT NULL,
--    "analise" VARCHAR(255) NOT NULL
--);
--ALTER TABLE "atlas"."tipo_analise" ADD CONSTRAINT "atlas_tipo_analise_id_tipo_analise_primary" PRIMARY KEY("id_tipo_analise");
--
--CREATE TABLE "atlas"."tipo_pedido"(
--    "id_tipo_pedido" BIGINT IDENTITY(1,1) NOT NULL,
--    "descricao" VARCHAR(255) NOT NULL
--);
--ALTER TABLE "atlas"."tipo_pedido" ADD CONSTRAINT "atlas_tipo_pedido_id_tipo_pedido_primary" PRIMARY KEY("id_tipo_pedido");
...
CREATE INDEX "atlas_estudos_data_criacao_index" ON "atlas"."estudos"("data_criacao");
...
ALTER TABLE "atlas"."alternativas" ADD CONSTRAINT "atlas_alternativas_id_obra_foreign" FOREIGN KEY("id_obra") REFERENCES "atlas"."obras"("id_obra");
