...
from models import Estudo, StatusTipo, ViewEstudos, Alternativa, Anexo, StatusEstudo, DocPadronizado, TipoSolicitacao
...
import pytz
from utils.docx_helper import preencher_template
