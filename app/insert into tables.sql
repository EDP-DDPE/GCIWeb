...
insert into gciweb.tipo_viabilidade(descricao) values ('Orçamento Estimado')
...
insert into gciweb.tipo_analise(analise) values ('Geração')
...
insert into gciweb.tipo_pedido(descricao) values ('Ligação Nova')
...
insert into gciweb.status_tipos(status, descricao, ativo) values ('Concluído', 'Concluído', 1)
